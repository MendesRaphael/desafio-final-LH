with
    ...
    , sales_data_joined as (
        ...
        left join special_offer as discount
            ...
            and sales_header.order_date between discount.dt_discount_start and discount.dt_discount_end
            and sales_detail.order_qty between discount.vl_min_qty_for_discount and coalesce(discount.vl_max_qty_for_discount, 9999999)
    )
